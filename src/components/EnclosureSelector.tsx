          ...
          {requests.map((request, index) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  {(showArrayLabel || !salesMode) && (
                    <div className="text-xs text-gray-500 dark:text-neutral-500">
                      ...
                      {!salesMode && (
                        <span className="invisible">{request.enclosure.nominal_impedance_ohms}Ω</span>
                      )}
                    </div>
                  )}
                </div>
                ...
                {/* Lock + remove at the top-right of the card (80% size) */}
                <div className="ml-auto flex flex-shrink-0 items-center gap-1">
                  ...
                  >
                    {isLocked ? (
                      ...
                      <svg className="h-4 w-4 text-gray-400 dark:text-neutral-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
